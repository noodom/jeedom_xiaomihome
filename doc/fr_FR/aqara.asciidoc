...
Là vous avez un numéro de version, cliquez dessus de façon répétée jusqu'à un message (oui en chinois, ça aide pas :)) et 2 nouvelles options apparaissent
